let handler = m => m; 
 ...
   let responses; 
   if (/^بحبك| عاوزه اتجوزك|يلوسيفار بحبك|بموت فيك|نتجوز|لوسيفار هنتجوز امتي| انت ليا| بموت فيك$/i.test(m.text)) { 
     responses = [ 
       'شكرا  ',  
       'هفكر في الموضوع',  
             'و انا',  
 ...
     ]; 
   }else if (/^ لوسيفار عامل ايه|عامله ايه|عاملين ايه|الدنيا عامله ايه|عاملين ايه يشباب$/i.test(m.text)) { 
     responses = [ 
 ...
     ]; 
   }else if (/^كل خرا|غبي|خول|هطرقك|معاق|علق$/i.test(m.text)) { 
     responses = [ 
       'حرام ي حب ',  
          ' ربنا يسامحك ',  
 ...
   }else if (/|لوسيفار|بوت|يا$اسكت$/i.test(m.text)) { 
     responses = [ 
       'اي يقلب لوسيفار 😍',  
          ' قلب عدنان😍',  
              'روح عدنان 😍',  
