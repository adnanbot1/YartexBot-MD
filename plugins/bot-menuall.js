...
let tags = {
'info': 'المعلومات 📄',
'grupo': 'قسم القروبات ⚡️',
'juegos': 'قسم الذكاء 🧸',
'descargas': 'قسم التحميل 🚀',
'jadibot': 'اوامر اخرئ للبوت 🤖', 
'nable': 'اوامر التفعيلات ⚙️', 
'internet': ' قسم البحث🔎',
'transformador': 'قسم التحويل 👏🏻', 
'sticker': 'قسم الاستكيرات 🧩',
'rg': 'اقسام اخرئ 🌱',
'audio': 'صوتيات-تأثيرات 🎶', 
'tools': 'ادوات البوت🧰', 
'anime': 'قسم الانمي 📍', 
'own': 'خاص في المالك 👑',
'ai': 'الذكاءالاصطناعي 🙋🏻‍♂️',
'imagenes': 'قسم تحميل الصور 🖼️',
}
const defaultMenu = {
before: `> ╭─❒ 「 *بوت-ڪَباؘسِ丫:١⁶𝑘𝑎𝑝𝑎𝑠* 🎗️ 」
> │○ *المستخدم:* %name
> │○ *المستخدمين:* %diamond
> │○ *المستوى:* %level
> │○ *الرتبة:* %role
